...
export default function Footer() {
    return (
        <footer className="bg-black border-t border-white/5 py-16 md:py-24 text-white pb-12 relative overflow-hidden">
            {/* Ambient Glow */}
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-10 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16 mb-14 lg:mb-24">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-4 mb-8 min-w-0">
                            ...
                            <div className="flex flex-col">
                                <span className="font-syne font-black text-white text-xl sm:text-2xl uppercase leading-none">
                                    Paras Sharma
                                </span>
                                <span className="font-mono text-[9px] text-acid-green tracking-[0.12em] sm:tracking-[0.25em] font-bold mt-1 opacity-60 break-words">
                                    ENGINEER_PROTOCOL_V4
                                </span>
                            </div>
                        </div>
                        <p className="font-mono text-sm leading-relaxed text-white/40 max-w-[360px] uppercase">
                            Full-Stack Engineer & AI Systems Architect. Building high-performance autonomous systems and premium digital interfaces.
                        </p>
                        <div className="mt-8 flex items-center font-mono text-[10px] uppercase text-acid-green tracking-[0.08em] sm:tracking-[0.18em] font-black gap-3 bg-white/5 w-fit max-w-full px-4 py-2 border border-white/5">
                    ...
                    {/* General links */}
                    <div>
                        <p className="font-mono text-[10px] font-black uppercase text-acid-pink tracking-[0.16em] mb-8 border-b border-white/5 pb-2 w-fit">
                            NAV_MAP
                        </p>
                ...
                {/* Divider */}
                <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 opacity-30">
                    <p className="font-mono text-[9px] text-white tracking-[0.08em] uppercase font-bold break-words">
                        © 2026 Paras Sharma // ALL_RIGHTS_RESERVED
                    </p>
                    <div className="flex flex-wrap gap-4 md:gap-8">
                        <p className="font-mono text-[9px] text-white tracking-[0.08em] uppercase font-bold">
                            ENCRYPTED_SSL
                        </p>
                        <p className="font-mono text-[9px] text-white tracking-[0.08em] uppercase font-bold">
                            UP_IN_THE_CLOUD
